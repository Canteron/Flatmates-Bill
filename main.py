...
class ResultsPage(MethodView):
    ...
    def post(self):
        billform = BillForm(request.form)
        # amount = billform.amount.data definir cada variable hace el programa más largo
        # period = billform.period.data
        #
        # name1 = billform.name1.data
        # days_in_house = billform.days_in_house1.data

        # the_bill = Bill(amount, period) los usamos cuando importamos la clase de flat.py
        # the_bill = flat.Bill(amount, days_in_house_1) cuando importamos el modulo entero. flat
